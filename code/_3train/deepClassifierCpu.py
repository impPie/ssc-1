...
class DeepClassifier():
    ...
    def fit(self, model, optimizer, train_loader, val_loader, epochs, batch_size):
        ...
        def log_validation_results(trainer):
            ...
            print("Validation Results - Epoch: {}  Avg val accuracy: {:.4f} Avg val loss: {:.4f} Time:{}"
                  .format(trainer.state.epoch, accuracy, loss, time.ctime()))
            ...
            if self.best_accuracy < accuracy:
                ...
                lgP.close()
            model.train()
            print("after 1 epoch --- %s  ---" % time.ctime())
