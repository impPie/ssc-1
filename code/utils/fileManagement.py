...
import random
from utils.classicalClassifier import ClassicalClassifier
...
def writeTrainFileIDsUsedForTraining(params, classifierID, fileTripletL):
    f = open(params.classifierDir +'/finalclassifier/'+ 'classifierTypes' + '.csv', 'a')
...
# def crossFoldsEEGAndFeatureFiles(params,trainNum,n_fold=10):
#     eegAndStageFiles = getAllEEGFiles(params)
#     # testNum = 1
#     train_fileTripletL = []
#     test_fileTripletL = []
